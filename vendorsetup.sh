...
git clone https://github.com/little-beryllium/android_device_xiaomi_sdm845-common_419.git -b 16.0 device/xiaomi/sdm845-common --depth=1

# Vendor Tree
rm -rf vendor/xiaomi/beryllium
git clone https://github.com/little-beryllium/android_vendor_xiaomi_beryllium_419.git -b 16.0 vendor/xiaomi/beryllium --depth=1

# Common Vendor Tree
rm -rf vendor/xiaomi/sdm845-common
git clone https://github.com/little-beryllium/android_vendor_xiaomi_sdm845-common_419.git -b 16.0 vendor/xiaomi/sdm845-common --depth=1

# Kernel Tree
rm -rf kernel/xiaomi/sdm845
git clone https://github.com/little-beryllium/android_kernel_xiaomi_sdm845_419.git -b 16.0 kernel/xiaomi/sdm845 --depth=1

# Hardware
rm -rf hardware/xiaomi
git clone https://github.com/little-beryllium/android_hardware_xiaomi.git -b 16.0 hardware/xiaomi
